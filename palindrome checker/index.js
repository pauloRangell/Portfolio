...
button = document.querySelector("#check-btn");
result = document.querySelector("#result");

let returnResult = (event) => {     
    if(inputText.value === ""){
        alert("Please input a value") 
    }else{
        result.textContent = isAPalindrome() ? `${inputText.value} is a palindrome`: `${inputText.value} is not a palindrome`;
    }
...
button.addEventListener("click", returnResult);
document.addEventListener("click", isAPalindrome);
